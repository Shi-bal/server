...
This implementation matches the working web app pipeline using probs.top1.
"""
...
class SnakeClassifierProbs:
    ...
    def classify(self, crop_path: str) -> Dict[str, Any]:
        ...
        Uses probs.top1 and probs.top1conf like the working pipeline.
        ...
        try:
            ...
            if cls_results.probs is not None:
                # Get top prediction using probs.top1 (like your working code)
...
def get_classifier_probs() -> SnakeClassifierProbs:
    """Get or create global classifier instance"""
    global _classifier
    if _classifier is None:
        _classifier = SnakeClassifierProbs()
    return _classifier